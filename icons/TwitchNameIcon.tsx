interface TwitchNameIconProps {
  className?: string;
  fill?: string;
  testId?: string;
}

const TwitchNameIcon = ({
  className,
  fill = "#FFFFFF",
  testId,
}: TwitchNameIconProps) => {
